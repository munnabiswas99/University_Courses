...
// Provides a template  for node of linked list
struct node
{
    char foodname[50];
    int quantity;
...
//global struct pointers to create and maintain linked list
struct node *headc = NULL,*newnode,*tailc = NULL; //for customer
...
//This function creates a node for admin
...
//This function creates a node for customer
...
//Function for maintaining total sales
...
//function performs the task for deleting the data from linked list
...
// function performs for deleting a food item from admin list
int deleteadmin()
{
...
//performs for deleting an item from customers ordered food item
int deletecustomer()
{
    printf("\n\t\t\t\t\tEnter serial no. of the food item which is to be deleted: ");
    int num;
...
//display the total bill of a customer
void displaybill()
{
    displayList(headc);
    struct node *temp = headc;
...
//Performs for delete entire linked list
...
//This function opens the admin section and provides its interface
void admin()
{
    printf("\n\t\t\t\t\t   ----------------------------------------------\n");
    ...
    while(1)
    {
        adminmenu(); //Shows admin menu

        int opt;
        scanf("%d",&opt); //Scan the choice of user

        if(opt==5)
            break;

        switch (opt) //Switch case using for perform the chosen option
        {
            case 1:
                displayList(head_s);
                break;
...
//This function opens the admin section and provides its interface and functionalities
void customer()
{
    int flag=0,j=1;
    char ch;
    ...
    while(1)
    {
        customermenu(); //prints customer menu

        int opt;
        scanf("%d",&opt); // Scan option for the menu
...
int main() //Program execution start from here
{
    //Initialize the admin linked list (order menu)
    ...
    while(1)
    {
        ...
        switch (choice) //Switch case using for perform the chosen option
        {
            case 1:
                admin();
                break;
